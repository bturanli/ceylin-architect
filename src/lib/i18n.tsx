...
const translations = {
  en: {
    ...
    "about.quote": "\"A design methodology rooted in curated simplicity, where organic materiality and spatial connections bridge the gap between the interior sanctuary and the natural world.\"",
  ...
  tr: {
    ...
    "about.quote": "\"Özenle seçilmiş sadeliğe dayanan bir tasarım metodolojisi; organik malzeme ve mekansal bağlantıların iç mekan sığınağı ile doğal dünya arasındaki boşluğu köprülediği bir yaklaşım.\"",

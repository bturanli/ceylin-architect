...
const translations = {
  en: {
    ...
    // Media Page
    "media.label": "Media",
    "media.title": "News & Updates",
    "media.subtitle": "Stay connected with the latest projects, press features, and insights from my architectural practice.",
    "media.news": "Latest News",
    "media.links": "Featured Links",
    "media.videos": "Videos",
    "media.news1.date": "January 2025",
    "media.news1.title": "New Portfolio Website Launch",
    "media.news1.desc": "Excited to announce the launch of my redesigned portfolio, showcasing recent projects and the design philosophy behind each one.",
    "media.news2.date": "December 2024",
    "media.news2.title": "Coastal Residence Featured in ArchDaily",
    "media.news2.desc": "The Bodrum Coastal Residence project was featured as a prime example of integrating modern design with Mediterranean landscape.",
    "media.news3.date": "November 2024",
    "media.news3.title": "Sustainable Design Workshop",
    "media.news3.desc": "Led a workshop on sustainable residential design principles at Istanbul Technical University.",
  ...
  tr: {
    ...
    // Media Page
    "media.label": "Medya",
    "media.title": "Haberler & Güncellemeler",
    "media.subtitle": "En son projeler, basın haberleri ve mimari pratiğimden içgörülerle bağlantıda kalın.",
    "media.news": "Son Haberler",
    "media.links": "Öne Çıkan Bağlantılar",
    "media.videos": "Videolar",
    "media.news1.date": "Ocak 2025",
    "media.news1.title": "Yeni Portfolyo Web Sitesi Yayında",
    "media.news1.desc": "Son projeleri ve her birinin arkasındaki tasarım felsefesini sergileyen yeniden tasarlanmış portfolyomun lansmanını duyurmaktan heyecan duyuyorum.",
    "media.news2.date": "Aralık 2024",
    "media.news2.title": "Sahil Rezidansı ArchDaily'de Yayınlandı",
    "media.news2.desc": "Bodrum Sahil Rezidansı projesi, modern tasarımı Akdeniz peyzajıyla bütünleştirmenin başarılı bir örneği olarak öne çıkarıldı.",
    "media.news3.date": "Kasım 2024",
    "media.news3.title": "Sürdürülebilir Tasarım Atölyesi",
    "media.news3.desc": "İstanbul Teknik Üniversitesi'nde sürdürülebilir konut tasarım ilkeleri üzerine bir atölye yönettim.",

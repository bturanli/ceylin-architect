...
const projectsData = [
  {
    ...
    images: Array.from({ length: 20 }, (_, i) => `/projects/1/${String(i + 1).padStart(2, "0")}.jpg`),
  },
  {
    id: 2,
    ...
    year: "2023",
    challengeKey: "project.2.challenge",
    aspectRatio: "wide" as const,
    images: Array.from({ length: 20 }, (_, i) => `/projects/2/${String(i + 1).padStart(2, "0")}.jpg`),
  },
  {
    id: 3,
    ...
    year: "2023",
    challengeKey: "project.3.challenge",
    aspectRatio: "square" as const,
    images: Array.from({ length: 20 }, (_, i) => `/projects/3/${String(i + 1).padStart(2, "0")}.jpg`),
  },
  {
    id: 4,
    ...
    year: "2022",
    challengeKey: "project.4.challenge",
    aspectRatio: "tall" as const,
    images: Array.from({ length: 20 }, (_, i) => `/projects/4/${String(i + 1).padStart(2, "0")}.jpg`),
  },
  {
    id: 5,
    ...
    year: "2024",
    challengeKey: "project.5.challenge",
    aspectRatio: "wide" as const,
    images: Array.from({ length: 20 }, (_, i) => `/projects/5/${String(i + 1).padStart(2, "0")}.jpg`),
  },
  {
    id: 6,
    titleKey: "project.6.title",
    thumbnail: "/projects/project-6.jpg",
    locationKey: "project.6.location",
    year: "2022",
    challengeKey: "project.6.challenge",
    aspectRatio: "square" as const,
    images: Array.from({ length: 20 }, (_, i) => `/projects/6/${String(i + 1).padStart(2, "0")}.jpg`),
  },
];
